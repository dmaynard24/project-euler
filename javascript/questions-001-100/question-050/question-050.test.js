...
test('gets the prime, below one-thousand, that can be written as the sum of the most consecutive primes to be 997,651', () => {
	expect(getSumOfConsecutivePrimes(1000)).toBe(953);
});

test('gets the prime, below one-million, that can be written as the sum of the most consecutive primes to be 997,651', () => {
